/* ============================================================
 * CheeseMan Games - GitHub / Community Integration
 * ============================================================
 * Handles fetching and rendering of the community announcement
 * feed from GitHub, local authentication (magic link / key),
 * user profile management, and settings UI state.
 * ============================================================ */

/* ---- Remote Data Source ---- */
const ANNOUNCEMENTS_URL = 'https://raw.githubusercontent.com/fkm-X3/my-database/main/Announcements.json';

/* ---- UI Element References (populated by initElements) ---- */
...
/**
 * Grabs references to all community/settings DOM elements and
 * attaches event listeners. Called once on DOMContentLoaded.
 */
...
/* ============================================================
 * Announcement Feed (Fetch + Render)
 * ============================================================ */

/**
 * Fetches announcements from the remote GitHub JSON endpoint,
 * sorts them newest-first, and renders the first page.
 */
...
/**
 * Renders an array of announcement rows into the feed container.
 * Handles both the initial render and "load more" appends.
 *
 * @param {Array} rows       - Announcement objects to render.
 * @param {boolean} isLoadMore - If true, appends to existing feed.
 */
...
/**
 * Appends a "Show More" button to the bottom of the feed.
 */
...
/**
 * Loads the next page of announcements and appends them to the feed.
 */
...
/**
 * Logs in the user locally by persisting username to localStorage.
 *
 * @param {string} username - Display name for the session.
 */
...
/**
 * Clears local auth state and reloads the page.
 */
...
/**
 * Updates the locally-stored display name from the settings input.
 */
...
/**
 * Initializes auth state from localStorage and wires up the
 * magic-link / sign-in button with a local fallback.
 */
function initAuth() {
...
/**
 * Wires up the settings-signout and profile-update buttons.
 */
